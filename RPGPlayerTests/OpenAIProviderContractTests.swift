...
struct OpenAIProviderContractTests {
    ...
    @Test
    func responsesFixturePreservesArbitraryRecordPatchFields() async throws {
    ...
    @Test
    func responsesModelDiscoveryExposesAPreviouslyUnknownModel() async throws {
        ...
        #expect(models[0].providerID == .openAI)
    }

    @Test
    func responsesCredentialLoadingCancellationNormalizesToCancelled() async {
    ...
    @Test
    func responsesFixturePreservesInterleavedAllowlistedToolCalls() async throws {
    ...
    @Test
    func responsesFixtureRejectsUnknownToolBeforeEmittingToolEvents() async throws {
    ...
    @Test
    func responsesRateLimitNormalizesWithoutLeakingCredential() async throws {
        let sentinel = "sk-fixture-openai-sentinel-123456"
        let provider = try await makeProvider(
...
private struct FixtureOpenAIProvider: Sendable {
